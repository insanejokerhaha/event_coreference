...
def getrizafile(name):
	fa1 = open('/home/zhanghao/MscProject/Unseen/articulation/'+name[:-4]+'.a1','r')
	fa2 = open('/home/zhanghao/MscProject/Unseen/articulation/'+name[:-4]+'.a2','r')
	a1 = fa1.readlines()
	entity = dict()
	for siga1 in a1:
		siga1dict = splitline(siga1,'T')
...
def getner(name):
	try:
		fner = open('/home/zhanghao/MscProject/Unseen/NEs/'+name+'.ann','r')
		ner = fner.readlines()
		rightner = list()
		for signer in ner:
...
def write_theme_and_cause(existing_trigger,existing_entity,unused,myevent,unusedID,myentity,ner,causeset,themeset,fa1,fa2,Tnum,Enum,ner_theme_matchpos,ner_cause_matchpos):
		...
		for unusedID, unused in mytrigger.items():
			if unused not in myusedtrigger:
				...
				if unused['name'] == 'Articulation':
					...
					Tnum, Enum = write_theme_and_cause(existing_trigger,existing_entity,unused,myevent,unusedID,myentity,ner,causeset,themeset,fa1,fa2,Tnum,Enum,ner_theme_matchpos,ner_cause_matchpos)
...
if __name__ == '__main__':
	main('/home/zhanghao/MscProject/Unseen/testset/Games/1/','/home/zhanghao/MscProject/Unseen/testset_align/Games/1/')
	main('/home/zhanghao/MscProject/Unseen/testset/Games/2/','/home/zhanghao/MscProject/Unseen/testset_align/Games/2/')
	main('/home/zhanghao/MscProject/Unseen/testset/Games/3/','/home/zhanghao/MscProject/Unseen/testset_align/Games/3/')
	main('/home/zhanghao/MscProject/Unseen/testset/Games/4/','/home/zhanghao/MscProject/Unseen/testset_align/Games/4/')
	main('/home/zhanghao/MscProject/Unseen/testset/Games/5/','/home/zhanghao/MscProject/Unseen/testset_align/Games/5/')
	main('/home/zhanghao/MscProject/Unseen/testset/MediaCity/','/home/zhanghao/MscProject/Unseen/testset_align/MediaCity/')
	main('/home/zhanghao/MscProject/Unseen/testset/Metrolink/','/home/zhanghao/MscProject/Unseen/testset_align/Metrolink/')