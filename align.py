...
def getmyfile(name):
	fa1 = open('/home/zhanghao/MscProject/Unseen/Bioshared/'+name+'.txt.a1','r')
	fa2 = open('/home/zhanghao/MscProject/Unseen/Bioshared/'+name+'.txt.a2','r')
	a1 = fa1.readlines()
	entity = dict()
	for siga1 in a1:
...
def getrizafile(name):
	fa1 = open('/home/zhanghao/MscProject/Unseen/articulation/'+name+'.a1','r')
	fa2 = open('/home/zhanghao/MscProject/Unseen/articulation/'+name+'.a2','r')
	a1 = fa1.readlines()
	entity = dict()
	for siga1 in a1:
		siga1dict = splitline(siga1,'T')
...
if __name__ == '__main__':
	files, names = get_files_name('/home/zhanghao/MscProject/Unseen/txt','.txt')
	for name in names:
		fa1 = open('/home/zhanghao/MscProject/Unseen/combalign/'+name+'.a1','w')
		fa2 = open('/home/zhanghao/MscProject/Unseen/combalign/'+name+'.a2','w')
		Tnum = 1
		Enum = 1
		ner = getner(name)
		myusedtrigger = list()
		...
		shutil.copyfile('/home/zhanghao/MscProject/Unseen/txt/'+name+'.txt','/home/zhanghao/MscProject/Unseen/combalign/'+name+'.txt')
