...
def getsrl(filepath):
	...
	os.system('/home/zhanghao/MscProject/semafor-master/bin/runSemafor.sh '+filepath+' /home/zhanghao/MscProject/book/srl/'+filename+'.srl 1')
	srlfile = '/home/zhanghao/MscProject/book/srl/'+filename+'.srl'
	return srlfile
...
def schema_align(schema_target,Tnum,Enum,textbounds,target,args,fa1,readtokenNum):
	...
	SchemaSubjectName = 'Subject_Entity'
	SchemaAgentName = 'Agent_Entity'
	arglist = list()
	if len(args) > 0:
...
def rewrite(readfile):
	...
	for li in jsonlines:
		...
		for target in js_string["frames"]:	
			if target["target"]['name'] in ["Statement", "Opinion", "Communicate_categorization", "Being_in_category", "Categorization"]: 
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Cause_proliferation_in_number", "Hindering", "Interior_profile_relation", "Gradable_proximity", "Coincidence", "Unattributed_information", "Dispersal", "Law", "Capability", "Change_direction", "Gathering_up", "Arranging", "Electricity", "Attributed_information", "Arriving", "Exercising", "Presence", "Preventing_or_letting", "Legal_rulings", "Cotheme", "Impression", "Participation", "Daring", "Gusto", "Exporting", "Commitment", "Chatting", "Collaboration", "Deciding", "Make_agreement_on_action", "Choosing", "Perception_active", "Aggregate", "Certainty", "Deserving", "Emanating", "Being_up_to_it", "Change_position_on_a_scale", "Alliance", "Remembering_information", "Practice", "Event", "Leadership", "Conferring_benefit", "Cause_to_make_progress", "Objective_influence", "Emergency", "Bail_decision", "Confronting_problem", "Accomplishment", "Request", "Being_operational", "Temporal_pattern", "Attempting_and_resolving_scenario", "Taking_sides", "Political_locales", "Subjective_influence", "Affirm_or_deny", "Name_conferral", "Bungling", "Renting_out", "Process_end", "Sending", "Dunking", "Remainder", "Smuggling", "Convey_importance", "Finish_competition", "Purpose", "Capacity", "Translating", "Invading", "Change_of_quantity_of_possession", "Process_stop", "Motion", "Complaining", "Heralding", "Change_of_consistency", "Roadways", "Cause_change_of_position_on_a_scale", "Within_distance", "Attack", "Reading_aloud", "Besieging", "Documents", "Sufficiency", "Reason", "Foreign_or_domestic_country", "Point_of_dispute", "Attending", "Becoming_a_member", "Economy", "Knot_creation", "Contacting", "Assemble", "Body_movement", "Waiting", "Atonement", "Level_of_force_exertion", "Spatial_contact", "Bringing", "Counterattack", "Touring", "Relational_political_locales", "Rotting", "Assistance", "Expend_resource", "Manufacturing", "Project", "Rite", "Desirable_event", "Submitting_documents", "Going_back_on_a_commitment", "Telling", "Installing", "Eventive_affecting", "Relational_natural_features", "Traversing", "Building", "Burying", "Renunciation", "Judgment_communication", "Hostile_encounter", "Create_physical_artwork", "Recording", "Misdeed", "Cooking_creation", "Surviving", "Topic", "Process_start", "Abounding_with", "Visiting", "Suicide_attack", "Social_event_individuals", "Mass_motion", "People_by_origin", "Intentionally_act", "Intentionally_create", "Duplication", "Clemency", "Front_for", "Frequency", "Fluidic_motion", "Containing", "Entourage", "Distributed_position", "Expected_location_of_person", "Reliance_on_expectation", "Directional_locative_relation", "Attempt_means", "Ingest_substance", "Manner", "Ingestion", "Expansion", "Self_motion", "Waking_up", "Removing", "Usefulness", "Expectation", "Detonate_explosive", "Redirecting", "Social_event_collective", "Origin", "Use_firearm", "Product_line", "Change_posture", "Dough_rising", "Awareness", "Elusive_goal", "Trust", "Having_or_lacking_access", "Visiting_scenario_arrival", "Lending", "Exchange", "Attempt", "Text", "Hit_or_miss", "Change_of_temperature", "Accuracy", "Text_creation", "Non-gradable_proximity", "Desirability", "Being_located", "Causation", "Passing", "Shoot_projectiles", "Quantity", "Operating_a_system", "Proliferating_in_number", "Forming_relationships", "Path_traveled", "Working_on", "Bounded_entity", "Records", "Dressing", "Process_pause", "Indigenous_origin", "Passing_off", "Partitive", "Goal", "Needing", "Responsibility", "Go_into_shape", "Using", "Reveal_secret", "Resolve_problem", "Light_movement", "Be_in_agreement_on_assessment", "Vehicle_landing", "Coming_to_be", "Quitting", "Process_resume", "Path_shape", "Range", "Get_a_job", "Tool_purpose", "Excreting", "Medium", "Adducing", "Surrendering_possession", "Organization", "Losing_someone", "Examination", "Working_a_post", "Team", "Undergoing", "Store", "Defending", "Departing", "Come_together", "Activity_finish", "Intercepting", "Piracy", "Desiring", "Commerce_sell", "Locale_by_event", "Remembering_to_do", "Left_to_do", "Conduct", "Birth_scenario", "Representing", "Operate_vehicle", "Change_tool", "Storing", "Aiming", "Locative_relation", "Withdraw_from_participation", "Giving", "Manipulation", "Commerce_pay", "Evading", "Cause_to_start", "Spatial_co-location", "Coming_to_believe", "Scrutiny", "Temporary_stay", "Competition", "Predicting", "People_by_jurisdiction", "Execute_plan", "Grasp", "Fame", "Placing", "Convoy", "Secrecy_status", "Military_operation", "Artifact", "Avoiding", "Getting", "Cause_motion", "Required_event", "Cause_fluidic_motion", "Location_on_path", "Being_employed", "Endeavor_failure", "Carry_goods", "Experience_bodily_harm", "Preference", "Conquering", "Offering", "Standing_by", "Social_event", "Expressing_publicly", "Reference_text", "Achieving_first", "Intentionally_affect", "Motion_noise", "Supply", "Success_or_failure", "Adjacency", "Religious_belief", "Motion_directional", "Transition_to_state"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Ingredients", "Creating"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Travel"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Buildings", "Funding", "Obligation_scenario", "Change_resistance", "Giving_in", "Cause_change_of_strength", "Cognitive_connection", "Relating_concepts", "Supporting", "Make_cognitive_connection", "Transitive_action", "Conditional_scenario", "Control", "Being_relevant", "Partiality", "Adopt_selection", "Protest"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Typicality", "Coming_up_with", "Activity_prepare", "Diversity", "Imitating", "Distinctiveness", "Similarity", "Correctness"]:
				...
				Enum = Enum + 1			
			elif target["target"]['name'] in ["Hiring", "Namesake", "Make_compromise", "Appellations", "Being_named", "Request_entity", "Referring_by_name", "Be_in_agreement_on_action"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Biological_area", "Locale_by_use", "Launch_process", "Isolated_places", "Taking", "Receiving", "Assigned_location", "Encounter", "Commerce_collect", "Activity_start", "Margin_of_resolution", "Body_decoration", "Delivery", "Commerce_buy", "Locale", "Product_delivery", "Relational_location", "Building_subparts", "Becoming", "Locale_by_characteristic_entity", "Forging", "Come_into_effect", "Be_on_alert", "Transition_to_a_quality", "Locale_by_ownership", "Cause_to_amalgamate", "Activity_ready_state", "Natural_features", "Amassing"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Progress", "Difficulty", "Breathing"]:
				...
				Enum = Enum + 1	
			elif target["target"]['name'] in ["Colonization", "Retaining", "Sleep", "Existence", "Lively_place", "Process_continue", "Have_associated", "Circumscribed_existence", "People_by_residence", "Cause_to_move_in_place", "Residence", "Activity_ongoing", "Being_active"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Exclude_member", "Connectors", "Inclusion", "Member_of_military", "Membership", "Processing_materials", "Duration_attribute", "Attaching", "Preserving", "Degree_of_processing"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Bearing_arms", "Cause_change", "Improvement_or_decline", "Exchange_currency", "Progression", "Undergo_transformation", "Ammunition", "Adjusting", "Weapon", "Undergo_change", "Change_event_duration", "Improvised_explosive_device", "Speed", "Reforming_a_system", "Nuclear_process", "Change_event_time"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Suasion", "Quarreling", "Jury_deliberation", "Concessive", "Successfully_communicate_message", "Entering_of_plea", "Speak_on_topic", "Reading_perception", "Sentencing", "Perception_experience", "Eclipse", "Warning", "Encoding", "Sign", "Education_teaching", "Questioning", "Punctual_perception", "Summarizing", "Hearsay", "Communication_manner", "Evidence", "Volubility", "Reasoning", "Reassuring", "Communication_noise", "Scrutinizing_for", "Estimating", "Claim_ownership", "Deny_or_grant_permission", "Studying", "Gesture", "Attempt_suasion", "Explaining_the_facts", "Verdict", "Response", "Reporting", "Patrolling", "Candidness", "Becoming_aware", "Research", "Meet_with", "Inspecting", "Health_response", "Hit_target", "Justifying", "Communication_response", "Verification", "Discussion", "Rewards_and_punishments", "Experimentation", "Trying_out", "Communication_means", "Estimated_value", "Communication", "Perception_body", "Notification_of_charges", "Prevarication", "Appearance"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Predicament", "Amounting_to", "Custom", "Unemployment_rate", "Adding_up"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Social_connection"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Popularity", "Aesthetics", "Thriving", "Preferred_alternative_scenario", "Age", "Grooming", "People_by_age", "Cause_to_resume", "Aging", "Social_desirability"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Import_export", "Filling", "Used_up"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Military", "Temporary_group", "Institutions"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Sports_jargon", "Evaluative_comparison"]:
				...
				Enum = Enum + 1
			elif target["target"]['name'] in ["Being_necessary", "Run_risk", "Emotion_directed", "Likelihood", "Experiencer_focus", "Taking_time", "Luck", "Mental_stimulus_exp_focus", "Judgment_direct_address", "Have_as_requirement", "Tolerating", "Labeling", "Bragging"]:
		...
		for unusedarg_pair in stash_arglist:
			for unusedarg in unusedarg_pair:
				if unusedarg[0]=='V':
					eventtypes[Enum] = 'Deep_Event'
					trigstart = textbounds[int(unusedarg[1])+readtokenNum].split()
					trigend = textbounds[int(unusedarg[2])+readtokenNum].split()
					triggerline ='	Deep_Event '+trigstart[0]+' '+trigend[1]+'	'+fulltext[int(trigstart[0]):int(trigend[1])]
					triggerlines.append(triggerline)
					for newunusedarg in unusedarg_pair:
						if newunusedarg[0]=='A0':
							...
							entityline = 'T'+str(Tnum)+'	Agent_Entity '+start[0]+' '+end[1]
							Event_hasAgent[Enum] = {'ID':'T'+str(Tnum),'name':'Agent_Entity'}
							fa1.write(entityline+'\n')
							Tnum = Tnum + 1
						elif newunusedarg[0]=='A1':
							start = textbounds[newunusedarg[1]+readtokenNum].split()
							end = textbounds[newunusedarg[2]+readtokenNum].split()
							entityline = 'T'+str(Tnum)+'	Subject_Entity '+start[0]+' '+end[1]
							Event_hasSubject[Enum] = {'ID':'T'+str(Tnum),'name':'Subject_Entity'}
							fa1.write(entityline+'\n')
							Tnum = Tnum + 1
...
if __name__ == "__main__":
	...
	rewrite('/home/zhanghao/MscProject/book/sections/9.txt')
	"""for l in List:
		rewrite(l)
		sys.stdout.flush()
		time.sleep(1)"""
	"""List, filenames = get_files_name('/home/zhanghao/MscProject/Unseen/txt','.txt')
	for l in List:
		rewrite(l)
		sys.stdout.flush()
		time.sleep(1)"""
	...
	"""t1 = open('/home/zhanghao/MscProject/testset/trainingset1.txt')
	t1map = js.loads(t1.read())
	t1.close()
	t2 = open('/home/zhanghao/MscProject/testset/trainingset2.txt')
	t2map = js.loads(t2.read())
	t2.close()
	t3 = open('/home/zhanghao/MscProject/testset/trainingset3.txt')
	t3map = js.loads(t3.read())
	t3.close()
	t4 = open('/home/zhanghao/MscProject/testset/trainingset4.txt')
	t4map = js.loads(t4.read())
	t4.close()
	t5 = open('/home/zhanghao/MscProject/testset/trainingset5.txt')
	t5map = js.loads(t5.read())
	t5.close()
	t10 = open('/home/zhanghao/MscProject/testset/trainingset10.txt')
	t10map = js.loads(t10.read())
	t10.close()
	for l in List:
		rewrite(l,t1map,1)
		sys.stdout.flush()
